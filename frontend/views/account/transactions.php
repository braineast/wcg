...
<div class="bottom_area">
    <table cellspacing="0" width="100%" class="bottom_areaInfoOne">
        <tbody><tr>
            <td width="33%" align="center">账户金额:￥<?= $summary && isset($summary['balance']) ? number_format($summary['balance'], 2) : number_format(0, 2); ?>元</td>
            <td width="34%" align="center" style=" border-right:0">理财收益:￥77元</td>
        </tr>
        <tr>
            <td width="33%" align="center">可用金额:￥13078元</td>
            <td width="34%" align="center" style=" border-right:0">冻结金额:￥500元</td>
        </tr>
        <tr>
